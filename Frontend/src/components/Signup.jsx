...
const Signup = () => {
  ...
  <div className="modal-box">
    ...
    <div className="flex justify-between mt-4 ">
        <button className="bg-pink-500 border rounded-md text-white px-3 py-1 hover:bg-pink-700 duration-200">Signup</button>
        <p className="text-xl"> 
...
//               <p className="text-xl">
//                 Have an account?
//                 <button className="underline text-blue-500 cursor-pointer" onClick={openLoginModal}>
//                   Login
//                 </button>
//                 <Login/>
//               </p>
