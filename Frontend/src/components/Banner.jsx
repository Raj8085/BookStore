        ...
        <>
            <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10">
                <div className="order-2 md:order-1 w-full md:w-1/2 mt-12 md:mt-32">
                    ...
                    <p className="text-xl">
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aut ad praesentium facere minus eos? Pariatur ad ipsum, rerum consectetur eos culpa alias molestiae, laudantium veritatis totam suscipit velit porro unde?
                    </p>
